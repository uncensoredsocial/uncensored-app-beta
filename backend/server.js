...
And my Supabase backend as SQL: -- WARNING: This schema is for context only and is not meant to be run.
...
CREATE TABLE public.recent_searches (
  ...
  user_id uuid,
  term text NOT NULL,
  search_type text NOT NULL DEFAULT 'all'::text,
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT recent_searches_pkey PRIMARY KEY (id),
  CONSTRAINT recent_searches_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id)
);
